...
public class ProductController {
	...
	public String allList(HttpServletRequest request, Model model) throws Exception {
		...
		/* 페이징을 위한 값 계산 */
		if (PKIND != null || pDegreeMin != -1 || pDegreeMax != -1 || pPriceMin != -1 || pPriceMax != -1
		...
		if (PKIND != null || pDegreeMin != -1 || pDegreeMax != -1 || pPriceMin != -1 || pPriceMax != -1
				|| pOrder != null || PSELL != null || PDATE != null) {
			// 조건이 있을 경우 조건 검색
			list = productService.allListSearchPaging(PKIND, pDegreeMin, pDegreeMax, pPriceMin, pPriceMax, pOrder,
	...
	public String aclList(HttpServletRequest request, Model model) throws Exception {
		...
		if (PKIND != null || pDegreeMin != -1 || pDegreeMax != -1 || pPriceMin != -1 || pPriceMax != -1
				|| pOrder != null || PSELL != null || PDATE != null) {
			// 조건이 있을 경우 조건 검색
			list = productService.aclListSearchPaging(PKIND, pDegreeMin, pDegreeMax, pPriceMin, pPriceMax, pOrder,
					PSELL, PDATE, START, END);
		} else {
