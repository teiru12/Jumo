...
public interface ProductService {
	...
	public List<Map<String, Object>> aclListSearchPaging(String PKIND, int PDEGREEMIN, int PDEGREEMAX, int PPRICEMIN, int PPRICEMAX, String PORDER, String PSELL, String PDATE, int START, int END) throws Exception;
