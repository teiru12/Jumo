...
<html lang="ko">
  ...
  <hr>
		...
		<br>
	    				<table class="table">
						  ...
						  <tbody>
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(img/product-3.png);"></div></td>
				...
				<p><a href="/Jumo/allList.al" class="btn btn-primary py-3 px-4">쇼핑 계속하기</a></p>
				</div>
    			<!-- <div>
